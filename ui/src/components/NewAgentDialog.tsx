...
export function NewAgentDialog() {
  ...
  function handleAskCeo() {
    ...
    openNewIssue({
      ...
      title: t("newAgent.ceoIssue.title", { defaultValue: "Create a new agent" }),
      description: t("newAgent.ceoIssue.description", { defaultValue: "(type in what kind of agent you want here)" }),
    });
  }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <span className="text-sm text-muted-foreground">{t("newAgent.header", { defaultValue: "Add a new agent" })}</span>
          <Button
            variant="ghost"
            size="icon-xs"
            ...
            <>
              ...
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("newAgent.recommendation.body", { defaultValue: "We recommend letting your CEO handle agent setup — they know the org structure and can configure reporting, permissions, and adapters." })}
                </p>
              </div>

              <Button className="w-full" size="lg" onClick={handleAskCeo}>
                <Bot className="h-4 w-4 mr-2" />
                {t("newAgent.actions.askCeo", { defaultValue: "Ask the CEO to create a new agent" })}
              </Button>
              ...
              <div className="text-center">
                ...
                >
                  {t("newAgent.actions.advancedConfig", { defaultValue: "I want advanced configuration myself" })}
                </button>
              </div>
            </>
          ) : (
            <>
              <div className="space-y-2">
                ...
                >
                  ...
                  {t("newAgent.actions.back", { defaultValue: "Back" })}
                </button>
                <p className="text-sm text-muted-foreground">
                  {t("newAgent.advanced.prompt", { defaultValue: "Choose your adapter type for advanced setup." })}
                </p>
              </div>
                  ...
                  >
                    {opt.recommended && (
                      <span className="absolute -top-1.5 right-1.5 bg-green-500 text-white text-[9px] font-semibold px-1.5 py-0.5 rounded-full leading-none">
                        {t("newAgent.advanced.recommended", { defaultValue: "Recommended" })}
                      </span>
                    )}
